...
import { DownloadApp } from '@/AppComponents/Logic/Data/DownloadApp';
...
export default function Home() {
  ...
  //определит что у тебя за OS
  const DownloadSystem = async() => {
    const Download = await DownloadApp()
  ...
  return (
    <>
      ...
      <main className={styles.Wrapper}>
        <NavbarLanding DownloadSystems={DownloadSystem} />
          ...
          <div className={styles.WallpaperContent}>
            ...
            <div className={styles.WallButtons}>
              <div className={styles.WallButtns}>
                <div id='MacOS' onClick={DownloadIos} className={styles.WallButton}>
                  <a>Скачать на Mac</a>
                ...
                <div id='Windows' onClick={DownloadWindows} className={styles.WallButton}>
            ...
            <div className={styles.StatsContents}>
              <div className={styles.StatsContent}>
                <div className={styles.Stats}>
                  <Image src={DetailsStats} alt={''} />
                </div>
                <div className={styles.StatsDetails}>
                  <h1>Подробная статистика</h1>
                  <a>Повседневная практика показывает, что сложившаяся структура организации требуют определения и уточнения системы обучения кадров, соответствует насущным потребностям. Идейные соображения высшего порядка, а также рамки и место обучения кадров требуют определения и уточнения системы обучения кадров</a>
                </div>                
              </div>
            </div>
          </div>
